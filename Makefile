# This Makefile is for the POE::SAPI::ConfigLoader extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/POE/SAPI/ConfigLoader.pm]
#     AUTHOR => q[Paul G Webster <paul@daemonrage.net>]
#     BUILD_REQUIRES => {  }
#     NAME => q[POE::SAPI::ConfigLoader]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/POE/SAPI/ConfigLoader.pm]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = POE::SAPI::ConfigLoader
NAME_SYM = POE_SAPI_ConfigLoader
VERSION = 0.03
...
MAKE = make
FULLEXT = POE/SAPI/ConfigLoader
BASEEXT = ConfigLoader
PARENT_NAME = POE::SAPI
DLBASE = $(BASEEXT)
VERSION_FROM = lib/POE/SAPI/ConfigLoader.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/POE/SAPI/ConfigLoader.pm
...
TO_INST_PM = lib/POE/SAPI/ConfigLoader.pm

PM_TO_BLIB = lib/POE/SAPI/ConfigLoader.pm \
	blib/lib/POE/SAPI/ConfigLoader.pm
...
DISTNAME = POE-SAPI-ConfigLoader
DISTVNAME = POE-SAPI-ConfigLoader-0.03
...
manifypods : pure_all  \
	lib/POE/SAPI/ConfigLoader.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/POE/SAPI/ConfigLoader.pm $(INST_MAN3DIR)/POE::SAPI::ConfigLoader.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               POE-SAPI-ConfigLoader' >> META_new.yml
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/POE/SAPI/ConfigLoader.pm blib/lib/POE/SAPI/ConfigLoader.pm 
